...
// Test $SAME_LENGTH_ENV where everything fits in one byte array
class Test1 {
    static String correctString = "Hello abcdefghijklmno";
    ...
    public static void main(String[] args) throws IOException {
        try {
            FileInputStream fis = new FileInputStream("../data/test1.txt");
