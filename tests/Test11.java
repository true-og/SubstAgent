...
// Test $SHORTER_ENV at the end of the file
class Test11 {
    static String correctString = "According to all known laws of aviation, there is no way a bee should be able to fly abcdefghijklmnopqrstuvwxyz";
    ...
    public static void main(String[] args) throws IOException {
        try {
            FileInputStream fis = new FileInputStream("../data/test11.txt");
