...
// Test $SHORTER_ENV split in 3 byte arrays, the entirety of the read content overflows
class Test8 {
    static String correctFirstString = "Hi abcdefghijklmnopqrstuvwxyz ";
    ...
    public static void main(String[] args) throws IOException {
        try {
            FileInputStream fis = new FileInputStream("../data/test5.txt");
            byte[] firstBuf = new byte[30];
